...
class product(models.Model):
    ...
    thumbnail_image_1       = models.ImageField(upload_to='media/product_photos',default='product image',null=False,blank=False)
    thumbnail_image_2       = models.ImageField(upload_to='media/product_photos',default='product image',null=True,blank=True)
    thumbnail_image_3       = models.ImageField(upload_to='media/product_photos',default='product image',null=True,blank=True)
    thumbnail_image_4       = models.ImageField(upload_to='media/product_photos',default='product image',null=True,blank=True)
